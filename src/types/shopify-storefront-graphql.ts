...
export type GetBundleMetaQuery = {
	product: {
		id: string;
		title: string;
		description: string;
...
export type CartCreateMutation = {
	cartCreate: {
		cart: { id: string; checkoutUrl: unknown } | null;
		...
		products: {
			edges: Array<{
				...
				node: {
					...
					images: {
						edges: Array<{ node: { url: unknown; altText: string | null } }>;
					};
					featuredImage: { url: unknown } | null;
					options: Array<{
						name: string;
...
export type GetBundleCollectionSlugsQueryVariables = Exact<{
	[key: string]: never;
}>;

export type GetBundleCollectionSlugsQuery = {
	collection: {
		handle: string;
...
>(
	...
	return useQuery<GetBundleMetaQuery, TError, TData>(
		...
		fetcher<GetBundleMetaQuery, GetBundleMetaQueryVariables>(
			dataSource.endpoint,
			dataSource.fetchParams || {},
			GetBundleMetaDocument,
			variables
		),
		options
	);
...
export const GetCollectionByHandleDocument = new TypedDocumentString(`
...
>(
	...
	return useQuery<GetBundleCollectionSlugsQuery, TError, TData>(
		variables === undefined
			? ["GetBundleCollectionSlugs"]
			: ["GetBundleCollectionSlugs", variables],
		fetcher<
			GetBundleCollectionSlugsQuery,
			GetBundleCollectionSlugsQueryVariables
		>(
			dataSource.endpoint,
			dataSource.fetchParams || {},
			GetBundleCollectionSlugsDocument,
			variables
		),
		options
	);
...
export const useGetVariantsQuery = <TData = GetVariantsQuery, TError = unknown>(
	dataSource: { endpoint: string; fetchParams?: RequestInit },
	...
	return useQuery<GetVariantsQuery, TError, TData>(
		...
		fetcher<GetVariantsQuery, GetVariantsQueryVariables>(
			dataSource.endpoint,
			dataSource.fetchParams || {},
			GetVariantsDocument,
			variables
