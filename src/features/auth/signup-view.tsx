		...
		<main className="flex grow items-center justify-center px-6 py-32">
			<div className="w-full max-w-md rounded-[2.5rem] border border-stone-100 bg-white p-8 shadow-sm md:p-12">
				<div className="mb-12 text-center">
					<span className="mb-4 block font-bold text-secondary text-xm">
						Join the Circle
					</span>
				...
				<form className="space-y-6">
					...
					<div className="space-y-2">
						<label className="font-bold text-secondary text-xm">Password</label>
						<Input placeholder="••••••••" required type="password" />
					</div>

					<p className="py-4 text-center text-secondary/60 text-xm leading-relaxed">
