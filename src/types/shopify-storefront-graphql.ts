...
export type GetCollectionsQuery = { collections: { edges: Array<{ node: { id: string, handle: string, title: string, description: string, descriptionHtml: unknown, image: { url: unknown, width: number | null, height: number | null, altText: string | null } | null } }> } };
...
export const useGetCollectionsQuery = <
    ...
    return useQuery<GetCollectionsQuery, TError, TData>(
      ...
      fetcher<GetCollectionsQuery, GetCollectionsQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, GetCollectionsDocument, variables),
      options
    )};
