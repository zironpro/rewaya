		...
		<div className="space-y-12">
			...
			<div>
				...
				<div className="relative">
					...
					/>
					<input
						className="h-12 w-full border border-stone-100 bg-stone-50 pr-4 pl-12 font-bold text-[10px] uppercase tracking-widest transition-all focus:border-primary focus:outline-none"
			...
			<div className="pt-8">
				<Button
					className="h-12 w-full bg-secondary font-black text-[9px] text-white uppercase tracking-widest hover:bg-primary"
				...
				<section className="container mx-auto mb-12 px-6">
					...
					<div className="text-center">
						...
						<h1 className="mb-8 font-black font-serif text-5xl text-secondary uppercase md:text-7xl">
							THE{" "}
							<span className="font-normal text-primary italic">ARCHIVE</span>.
						</h1>
					</div>
				</section>
