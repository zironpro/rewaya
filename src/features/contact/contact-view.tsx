			...
			<div className="container mx-auto px-6">
				<div className="mb-32 grid grid-cols-1 gap-32 lg:grid-cols-2">
					...
					<div className="flex flex-col justify-between py-12">
						<div>
							<span className="mb-12 block font-bold text-stone-400 text-xm">
								Get in touch
							</span>
							...
							<div className="space-y-12">
								<div>
									<h3 className="mb-4 font-bold text-stone-400 text-xm">
										Email Us
									</h3>
								...
								<div>
									...
									<div className="flex gap-8">
										<a
											className="font-bold text-xm transition-colors hover:text-stone-400"
											href="#"
										>
											Instagram
										</a>
						...
						<div className="mt-24 border-stone-100 border-t pt-12">
							<p className="max-w-xs text-stone-400 text-xm leading-loose">
