				...
				<div className="grid grid-cols-1 gap-20 md:grid-cols-2">
					...
					<div className="space-y-6">
						...
						<div className="grid grid-cols-4 gap-4">
							{[1, 2, 3, 4].map((i) => (
								<div
									className="relative aspect-square cursor-pointer overflow-hidden bg-stone-50 opacity-50 transition-opacity hover:opacity-100"
									key={i}
								>
									<Image
										alt="thumbnail"
					...
					<div className="flex flex-col">
						...
						<h1 className="mb-2 font-black font-serif text-4xl tracking-tight md:text-6xl">
							{product.title}
						</h1>
						...
						<div className="mb-16 space-y-8">
							...
							<button className="w-full bg-primary py-6 font-bold text-sm text-white shadow-lg transition-all duration-500 hover:scale-[1.02] hover:bg-secondary hover:shadow-2xl active:scale-[0.98]">
								Add to Collection
							</button>
						</div>
